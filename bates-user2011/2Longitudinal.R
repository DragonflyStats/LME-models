### R code from vignette source '/home/bates/Documents/slides/2011-08-15-Coventry/2Longitudinal.Rnw'
...
###################################################
### code chunk number 4: fm1
###################################################
fm1 <- lmer(Reaction ~ Days + (Days|Subject), sleepstudy)


###################################################
### code chunk number 5: sleepZ
###################################################
print(image(fm1@re@Zt,xlab=NULL,ylab=NULL,sub=NULL))


###################################################
### code chunk number 6: sm1
###################################################
(fm1 <- lmer(Reaction ~ Days + (Days|Subject), sleepstudy))


###################################################
### code chunk number 7: fm2
###################################################
(fm2 <- lmer(Reaction ~ Days + (1|Subject) + (0+Days|Subject), sleepstudy))


###################################################
### code chunk number 8: anovafm1fm2
###################################################
anova(fm2, fm1)


###################################################
### code chunk number 9: rr1
###################################################
(rr2 <- ranef(fm2))


###################################################
### code chunk number 10: rr2plot
###################################################
print(plot(rr2, aspect = 1, type = c("g", "p"))[[1]])


###################################################
### code chunk number 11: shrinkage
###################################################
...
###################################################
### code chunk number 12: shrinkfit
###################################################
print(xyplot(Reaction ~ Days | Subject, sleepstudy, aspect = "xy",
             layout = c(9,2), type = c("g", "p", "r"),
             coef.list = df[,3:4],
...
###################################################
### code chunk number 13: caterpillar
###################################################
...
###################################################
### code chunk number 15: Multiplot1
###################################################
...
###################################################
### code chunk number 16: Multiplot2
###################################################
...
###################################################
### code chunk number 23: fm9
###################################################
(fm9 <- lmer(Adj ~ Trt + (1|Trt:Location) + (1|Location), Multilocation, REML=FALSE))


###################################################
### code chunk number 24: fm10
###################################################
(fm10 <- update(fm9, . ~ . + (1|Grp)))


###################################################
### code chunk number 25: anovafm10
###################################################
anova(fm10, fm8)


###################################################
### code chunk number 26: fm11 (eval = FALSE)
###################################################
## fm11 <- lmer(Adj ~ Trt + (Trt|Location) + (1|Grp), Multilocation, REML=FALSE)


###################################################
### code chunk number 27: fm11 (eval = FALSE)
###################################################
## fm11 <- lmer(Adj ~ Trt + (0+Trt|Location) + (1|Grp), Multilocation, REML=FALSE)


###################################################
### code chunk number 28: 2Longitudinal.Rnw:652-653
###################################################
cat(paste(capture.output(print(fm11))[4:15], collapse="\n"), "\n")


###################################################
### code chunk number 29: fm11kappa
###################################################
...
###################################################
### code chunk number 30: fm11verb
###################################################
fm11 <- lmer(Adj ~ Trt + (0+Trt|Location) + (1|Grp), Multilocation, REML=FALSE, verbose=2L)


###################################################
### code chunk number 31: fm11
###################################################
fm11@re@theta


###################################################
### code chunk number 32: EarlyData
###################################################
...
###################################################
### code chunk number 33: fm12
###################################################
Early <- within(Early, tos <- age-0.5)
fm12 <- lmer(cog ~ tos+trt:tos+(tos|id), Early, verbose=2L)


###################################################
### code chunk number 34: fm12show
###################################################
