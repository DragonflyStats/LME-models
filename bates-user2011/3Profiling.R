### R code from vignette source '/home/bates/Documents/slides/2011-08-15-Coventry/3Profiling.Rnw'
...
###################################################
### code chunk number 2: pr1 (eval = FALSE)
###################################################
## pr1 <- profile(fm1M <- lmer(Yield ~ 1+(1|Batch), Dyestuff, REML=FALSE))
...
###################################################
### code chunk number 3: pr1plot
###################################################
print(xyplot(pr1, aspect=1.3, layout=c(3,1)))


###################################################
### code chunk number 4: pr1plot2show (eval = FALSE)
###################################################
## xyplot(pr1, aspect=0.7, absVal=TRUE)


###################################################
### code chunk number 5: pr1plot2
###################################################
print(xyplot(pr1, aspect=0.7, absVal=TRUE, strip=FALSE, strip.left=TRUE,layout=c(3,1)))


###################################################
### code chunk number 6: confintpr1
###################################################
confint(pr1)


###################################################
### code chunk number 7: confintpr1.99
###################################################
confint(pr1, level=0.99)


###################################################
### code chunk number 8: sigmaprof
###################################################
...
###################################################
### code chunk number 9: sigma1prof
###################################################
zeta <- sqrt(qchisq(c(0.5,0.8,0.9,0.95,0.99), 1))
zeta <- c(-rev(zeta), 0, zeta)
...
###################################################
### code chunk number 10: pr1density
###################################################
print(densityplot(pr1, layout=c(1,3), strip=FALSE, strip.left=TRUE))


###################################################
### code chunk number 11: pr1vardensity
###################################################
print(densityplot(lme4a:::varianceProf(pr1), layout=c(1,2), strip=FALSE, strip.left=TRUE))


###################################################
### code chunk number 12: pr1pairsshow (eval = FALSE)
###################################################
## splom(pr1)


###################################################
### code chunk number 13: pr1pairs
###################################################
print(splom(pr1))


###################################################
### code chunk number 14: pr1varpairs
###################################################
print(splom(lme4a:::varianceProf(pr1)))


###################################################
### code chunk number 15: pr8 (eval = FALSE)
###################################################
